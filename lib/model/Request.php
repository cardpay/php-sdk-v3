...
class Request implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param string $id Request ID, should be unique for time period of 30 minutes
     *
     * @return $this
     */
    ...
    {
        if ((mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Request., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Request., must be bigger than or equal to 1.');
        }
