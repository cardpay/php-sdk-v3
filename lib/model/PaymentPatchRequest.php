...
class PaymentPatchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentPatchRequest';
     ...
     * Sets operation
     *
     * @param string $operation If `operation` is CONFIRM_3DS then field `PaRes` is required If `operation` is CHANGE_STATUS then field `payment_data` is required
     *
     * @return $this
     */
