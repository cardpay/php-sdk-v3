...
class ChangeSubscriptionStatusClaimResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChangeSubscriptionStatusClaimResponse';
     ...
     * Sets details
     *
     * @param string $details Change claim details, errors etc.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Status of claim: `IN_PROCESS` - claim is in queue to being processed `STOPPED` - claim failed to be processed `COMPLETED` - claim successfully processed
     *
     * @return $this
     */
     ...
     *
     * @return \Cardpay\model\ClaimResponseSubscriptionData
     */
     ...
     *
     * @param \Cardpay\model\ClaimResponseSubscriptionData $subscription_data Subscription data
     *
     * @return $this
     */
