...
class MobilePaymentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MobilePaymentRequest';
     ...
     * Gets merchant_order
     *
     * @return \Cardpay\model\MobilePaymentMerchantOrder
     */
     ...
     * Sets merchant_order
     *
     * @param \Cardpay\model\MobilePaymentMerchantOrder $merchant_order Merchant order data
     *
     * @return $this
     */
