...
class RefundResponseCustomer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RefundResponseCustomer';
     ...
     * Sets email
     *
     * @param string $email Customer's e-mail address, here can be value returned from payment method - in case then in Merchant request `customer.email` wasn't presented
     *
     * @return $this
     */
