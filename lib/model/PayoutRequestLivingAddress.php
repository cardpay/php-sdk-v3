...
class PayoutRequestLivingAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayoutRequestLivingAddress';
    ...
    public function setAddress($address)
    {
        if (!is_null($address) && (mb_strlen($address) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address when calling PayoutRequestLivingAddress., must be smaller than or equal to 100.');
        }
        if (!is_null($address) && (mb_strlen($address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address when calling PayoutRequestLivingAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 20)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PayoutRequestLivingAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PayoutRequestLivingAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PayoutRequestLivingAddress., must be smaller than or equal to 3.');
        }
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PayoutRequestLivingAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 20)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PayoutRequestLivingAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($state) && (mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PayoutRequestLivingAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 17)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling PayoutRequestLivingAddress., must be smaller than or equal to 17.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling PayoutRequestLivingAddress., must be bigger than or equal to 0.');
        }
