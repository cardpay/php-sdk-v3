...
class RefundRequestMerchantOrder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RefundRequestMerchantOrder';
     ...
     * Sets description
     *
     * @param string $description Description (reason) for refund
     *
     * @return $this
     */
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RefundRequestMerchantOrder., must be smaller than or equal to 50.');
        }
        if (!is_null($id) && (mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RefundRequestMerchantOrder., must be bigger than or equal to 1.');
        }
