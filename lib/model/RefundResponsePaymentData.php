...
class RefundResponsePaymentData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RefundResponsePaymentData';
     ...
     * Sets id
     *
     * @param string $id Id of refunded or partial refunded payment
     *
     * @return $this
     */
     ...
     *
     * @param float $remaining_amount Payment amount left after refund was made
     *
     * @return $this
     */
