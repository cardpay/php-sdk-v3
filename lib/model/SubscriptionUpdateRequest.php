...
class SubscriptionUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'operation' => 'string',
        'subscription_data' => '\Cardpay\model\SubscriptionUpdateRequestSubscriptionData'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subscription_data'] === null) {
            $invalidProperties[] = "'subscription_data' can't be null";
        }
     ...
     * Sets operation
     *
     * @param string $operation Set operation on subscription: `CHANGE_STATUS` - initiates status changing `REPAYMENT` - **for installment only**; makes repayment in advance `CHANGE_FILING` - replaces card binding via new filing id.
     *
     * @return $this
     */
     ...
     *
     * @return \Cardpay\model\SubscriptionUpdateRequestSubscriptionData
     */
     ...
     *
     * @param \Cardpay\model\SubscriptionUpdateRequestSubscriptionData $subscription_data Subscription data
     *
     * @return $this
     */
