...
class PaymentRequestCryptocurrencyAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentRequestCryptocurrencyAccount';
    ...
    protected static $setters = [
        'rollback_address' => 'setRollbackAddress'
    ];
    ...
    protected static $getters = [
        'rollback_address' => 'getRollbackAddress'
    ];
    ...
    {
        $this->container['rollback_address'] = isset($data['rollback_address']) ? $data['rollback_address'] : null;
    }
    ...
    /**
     * Gets rollback_address
     *
     * @return string
     */
    public function getRollbackAddress()
    {
        return $this->container['rollback_address'];
    }

    /**
     * Sets rollback_address
     *
     * @param string $rollback_address Customer's bitcoin address to be used for rollback
     *
     * @return $this
     */
