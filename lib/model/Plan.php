...
class Plan implements ModelInterface, ArrayAccess
{
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Plan., must be smaller than or equal to 32.');
        }
        if (!is_null($id) && (mb_strlen($id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Plan., must be bigger than or equal to 0.');
        }
