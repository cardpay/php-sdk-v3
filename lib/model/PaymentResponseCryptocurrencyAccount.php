...
class PaymentResponseCryptocurrencyAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentResponseCryptocurrencyAccount';
     ...
     * Sets crypto_address
     *
     * @param string $crypto_address Bitcoin address for created transaction
     *
     * @return $this
     */
     ...
     * Sets prc_amount
     *
     * @param float $prc_amount Transaction amount (only for FIAT-BTC scenario)
     *
     * @return $this
     */
     ...
     * Sets prc_currency
     *
     * @param string $prc_currency Currency of transaction (only for FIAT-BTC scenario)
     *
     * @return $this
     */
