...
class PaymentsApi
{
    ...
    protected function getPaymentsRequest($request_id, $currency = null, $end_time = null, $max_count = null, $merchant_order_id = null, $payment_method = null, $sort_order = null, $start_time = null)
    {
        ...
        if (strlen($request_id) < 0) {
            throw new \InvalidArgumentException('invalid length for "$request_id" when calling PaymentsApi.getPayments, must be bigger than or equal to 0.');
        }
        ...
        if ($payment_method !== null && strlen($payment_method) > 100) {
            throw new \InvalidArgumentException('invalid length for "$payment_method" when calling PaymentsApi.getPayments, must be smaller than or equal to 100.');
        }
    ...
    /**
     * Operation process3dsVerification
     *
     * Process 3ds verification
     *
     * @param  \Cardpay\model\AuthenticationRequest $request request (required)
     *
     * @throws \Cardpay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cardpay\model\AuthenticationResponse
     */
    public function process3dsVerification($request)
    {
        list($response) = $this->process3dsVerificationWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation process3dsVerificationWithHttpInfo
     *
     * Process 3ds verification
     *
     * @param  \Cardpay\model\AuthenticationRequest $request request (required)
     ...
     * @throws \Cardpay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cardpay\model\AuthenticationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function process3dsVerificationWithHttpInfo($request)
    {
        $returnType = '\Cardpay\model\AuthenticationResponse';
        $request = $this->process3dsVerificationRequest($request);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cardpay\model\AuthenticationResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation process3dsVerificationAsync
     *
     * Process 3ds verification
     *
     * @param  \Cardpay\model\AuthenticationRequest $request request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function process3dsVerificationAsync($request)
    {
        return $this->process3dsVerificationAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation process3dsVerificationAsyncWithHttpInfo
     *
     * Process 3ds verification
     *
     * @param  \Cardpay\model\AuthenticationRequest $request request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function process3dsVerificationAsyncWithHttpInfo($request)
    {
        $returnType = '\Cardpay\model\AuthenticationResponse';
        $request = $this->process3dsVerificationRequest($request);
    ...
    /**
     * Create request for operation 'process3dsVerification'
     *
     * @param  \Cardpay\model\AuthenticationRequest $request request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function process3dsVerificationRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling process3dsVerification'
            );
        }

        $resourcePath = '/api/authentications/threedsecure';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
