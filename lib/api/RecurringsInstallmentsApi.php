...
class RecurringsInstallmentsApi
{
    ...
    protected function getInstallmentPaymentsRequest($request_id, $currency = null, $end_time = null, $max_count = null, $merchant_order_id = null, $payment_method = null, $recurring_types = null, $sort_order = null, $start_time = null, $type = null)
    {
        ...
        if (strlen($request_id) < 0) {
            throw new \InvalidArgumentException('invalid length for "$request_id" when calling RecurringsInstallmentsApi.getInstallmentPayments, must be bigger than or equal to 0.');
        }
        ...
        if ($payment_method !== null && strlen($payment_method) > 100) {
            throw new \InvalidArgumentException('invalid length for "$payment_method" when calling RecurringsInstallmentsApi.getInstallmentPayments, must be smaller than or equal to 100.');
        }
